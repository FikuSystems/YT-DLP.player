...
{
    public partial class frm_DownloadingDialog : Form
    {
        public frm_DownloadingDialog()
        {
            InitializeComponent();
        ...
        private void frm_DownloadingDialog_FormClosing(object sender, FormClosingEventArgs e)
        {
